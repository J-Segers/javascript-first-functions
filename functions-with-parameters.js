...
const merged = merge("abra", "cadabra");
console.log(merged);
...
function calculateDogYears(humanYears) {
  let calculatedDogYears = humanYears * 7;
  return calculatedDogYears;
}

let dogYears = calculateDogYears(12);
...
function wrapper(str1, str2) {
  return str2 + str1 + str2;
}

const wrapped = wrapper("bril", "*");
console.log(wrapped);
...
const createdStr = createDetailString({ firstName: 'Kees', lastName: 'Klaasen', profession: 'brandweerman'});
